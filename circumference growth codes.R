## Question-08 (Import this csv file into an R object. What are the column names?)
...
## Question-07 (Calculate the mean and standard deviation of tree circumference at the start and end of the study at both sites.)
...
## Question-08  (Make a box plot of tree circumference at the start and end of the study at both sites.)
...
## Question-09 (Calculate the mean growth over the past 10 years at each site.)
